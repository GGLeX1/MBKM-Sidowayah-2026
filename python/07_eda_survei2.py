...
DATA_RAW   = BASE_DIR / "data" / "raw"        / "survei_2_raw.csv"
DATA_OUT   = BASE_DIR / "data" / "processed"  / "survei_2_clean.csv"
REPORT_DIR = BASE_DIR / "reports" / "eda_survei2"
...
KOLOM_INFO = {
    ...
    "Apakah Anda tertarik jika ada Reward/hadiah untuk memilah sampah.": ("R1_tertarik", "Reward"),
    "Seberapa besar Reward/hadiah memengaruhi keputusan Anda.": ("R2_memengaruhi", "Reward"),
    "Apakah Reward/hadiah saat ini menarik.": ("R3_reward_menarik", "Reward"),
    "Apakah usaha memilah sampah sebanding dengan Reward/hadiah yang diberikan.": ("R4_usaha_sebanding", "Reward")
}
...
print("=" * 65)
print("  EDA SURVEI 2 — Program Pemilahan Sampah | Desa Sidowayah")
print("=" * 65)
...
kat_means = {}
for kat in ["Pengetahuan", "Sikap", "Perilaku & Kebiasaan", "Reward"]:
...
for ax, kat in zip(axes, ["Pengetahuan","Sikap","Perilaku & Kebiasaan","Reward"]):
    cols = [v[0] for v in KOLOM_INFO.values() if v[1] == kat]
...
ax.set_title("Heatmap Korelasi Antar Semua Variabel Survei 2",
...
df["skor_reward"]      = df[[v[0] for v in KOLOM_INFO.values() if v[1]=="Reward"]].mean(axis=1)
...
print(f"\n  Output → {REPORT_DIR}")
print("\n[SELESAI] 01_eda_survei2.py berhasil dijalankan.\n")